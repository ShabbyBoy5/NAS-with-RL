...
DQN_EPSILON_DECAY = 0.001 # Linear decay
...
REWARD_ACCURACY_WEIGHT = 1.0  # Weight for accuracy in reward
REWARD_PARAMETER_PENALTY_WEIGHT = 0.01 # Weight for parameter penalty in reward (new enhancement)
...
# --- **Layer Types (moved from search_space.py)** ---
LAYER_TYPES = [
